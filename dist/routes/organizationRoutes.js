 ...
 */
router.get("/", organizationController_1.getOrganizationsController);
/**
 * @swagger
 * /organizations:
 *   post:
 ...
 */
router.post("/", organizationController_1.createOrganizationController);
/**
 * @swagger
 ...
 */
router.get("/:id", organizationController_1.getOrganizationsByUserIdController);
/**
 * @swagger
 * /organizations/{id}:
 *   delete:
 ...
 */
router.delete("/:id", organizationController_1.delOrganizationByIdController);
